...
{?>
        <div class="contenntt">
    <a class="heading " href="#">Department Books</a>
    <table class="table">
    ...
    <?php
        ...
        include("connect.php");
        $sql="SELECT * FROM `dept_issued_book` WHERE username='$_SESSION[id]' ";
                ...
                echo "<tr>";
                        ...
                        if( $d > $row['due_date'])
                        {
                                ...
                                echo"<form action='' method='post'>";
                                         ...
                                         echo"<input  name='reissue1' type='hidden' value='";echo $row['book_id'];echo"'>";  
                                echo"</form>";
        ...
        { 
             ...
             $sq="UPDATE `dept_issued_book`
             SET `issued_date`=CURDATE(),`due_date`= ADDDATE(`issued_date`, INTERVAL 15 DAY)
             WHERE `username`='$_SESSION[id]' AND `Book_id`='$book_id';";
